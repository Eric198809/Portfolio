    ...
    <>
      ...
      <div className="about_container">
        ...
        <p>
          ...
          commerce/marketing j'ai décidé de changer de voie et de me reconvertir
          professionnellement et de faire de ma passion ma profession. <br />
          <br />
          ...
          Back-end. <br />
          <br />
          Aujourd'hui j'aime imaginer, créer , apprendre sans cesse de nouvelles
          choses et me lancer dans de nouveaux projets plus passionnants les uns
          que les autres.
        </p>
      </div>
    </>
